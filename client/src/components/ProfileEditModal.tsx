...
import { Loader2, Check, Upload, Trash2, History, User } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-black/95 border-primary/30 text-white max-w-md">
        <DialogHeader>
          <DialogTitle className="text-lg font-tech text-primary">Profile Center</DialogTitle>
          <DialogDescription className="text-muted-foreground text-sm">
            Manage your cosmic identity and view your activity in the void.
          </DialogDescription>
        </DialogHeader>
        
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-white/5 border border-white/10 p-1 mb-6">
            <TabsTrigger value="profile" className="data-[state=active]:bg-primary data-[state=active]:text-black gap-2">
              <User className="w-4 h-4" /> Profile
            </TabsTrigger>
            <TabsTrigger value="history" className="data-[state=active]:bg-primary data-[state=active]:text-black gap-2">
              <History className="w-4 h-4" /> Void History
            </TabsTrigger>
          </TabsList>
